        ...
        child: CustomScrollView(
          slivers: <Widget>[
            ...
            SliverAppBar(
              ...
              flexibleSpace:
                  // FlexibleSpaceBar(
                  //   // centerTitle: popular.PopularBookModel.title,
                  //    background: Image(
                  //      // image: AssetImage(popular.populars[index].image),
                  //      image: AssetImage(popularBookModel.image),
                  //      // image: AssetImage(popularBookData[index]["image"]),
                  //      fit: BoxFit.cover,
                  //    )
                  //   // AssetImage(populars[index].image),
                  // ),
                  Container(
                // color: Color(popular.PopularBookModel.color.),
                height: MediaQuery.of(context).size.height * 0.5,
                // color: Color(popularBookModel.color), niche kra def
                child: Stack(
                  children: <Widget>[
                    Positioned(
                      left: 15,
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          // image: DecorationImage(image: AssetImage(popularBookModel.image),
                ...
                [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      // child: _selected == 0 ? newlyReleased() : _selected == 1 ? bestSeller() : trending(),
                      dessum == 1 ?  widget.popularBookModel.description : widget.popularBookModel.summary,
